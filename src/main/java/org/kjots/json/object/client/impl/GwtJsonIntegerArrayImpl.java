...
/**
 * GWT JSON Integer Array Implementation.
 * <p>
 ...
 */
public class GwtJsonIntegerArrayImpl extends GwtJsonArrayImpl implements JsonIntegerArray {
  /**
   * Construct a new GWT JSON Integer Array Implementation.
   *
   * @param jsIntegerArray The JavaScript integer array.
   */
  public GwtJsonIntegerArrayImpl(JsArrayInteger jsIntegerArray) {
    super(jsIntegerArray);
  }
