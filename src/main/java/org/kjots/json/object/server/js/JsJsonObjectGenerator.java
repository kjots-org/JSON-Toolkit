 ...
 */
public class JsJsonObjectGenerator {
  /**
  ...
  public Class<? extends JsJsonObjectImpl> getJsonObjectImplClass(Class<? extends JsonObject> jsonObjectClass) {
    Class<?> jsonObjectImplClass;
    
    if (JsJsonObjectImpl.class.isAssignableFrom(jsonObjectClass)) {
      jsonObjectImplClass = jsonObjectClass;
    }
    else {
      try {
        jsonObjectImplClass = Class.forName(jsonObjectClass.getName() + "Impl", true, JsJsonObjectGenerator.class.getClassLoader());
      }
    ...
    return (Class<? extends JsJsonObjectImpl>)jsonObjectImplClass;
  }
   ...
   */
  @SuppressWarnings("unchecked")
  private Class<? extends JsJsonObjectImpl> defineImplClass(byte[] implClassBytes) {
    ...
    try {
      return (Class<? extends JsJsonObjectImpl>)defineClassMethod.invoke(JsJsonObjectGenerator.class.getClassLoader(), null, implClassBytes, 0, implClassBytes.length);
    } 
  ...
  private byte[] generateImplClassBytes(Class<? extends JsonObject> jsonObjectClass) {
    ...
    Class<? extends JsJsonObjectImpl> superJsonObjectImplClass;
    
    Class<?> implementedInterface = implementedInterfaces[0];
    if (implementedInterface.equals(JsonObject.class)) {
      superJsonObjectImplClass = JsJsonObjectImpl.class;
    }
    else {
