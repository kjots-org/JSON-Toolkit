 ...
 */
public interface JsonStringPropertyAdapter<T> extends JsonPropertyAdapter {
  /**
   ...
   */
  public String toJsonProperty(T t);
   ...
   */
  public T fromJsonProperty(String propertyValue);
}
