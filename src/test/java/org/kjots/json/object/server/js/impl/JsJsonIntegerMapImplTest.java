...
import org.kjots.json.object.server.js.impl.JsJsonIntegerMapImpl;
 ...
 */
public class JsJsonIntegerMapImplTest extends JsonIntegerMapImplTestBase<Object> {
  /** The injector. */
   ...
   */
  @Override
  protected JsonIntegerMap createJsonIntegerMap(Object object) {
    return new JsJsonIntegerMapImpl(this.getJsEngine(), object);
  }
